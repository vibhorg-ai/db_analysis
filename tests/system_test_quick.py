#!/usr/bin/env python3
"""
Quick system test runner for DB Analyzer v5 - all tests with shorter timeouts.
"""
...
def test_health_issues(conn_id):
    ...
    if r:
        ...
        record("Issues", "Returns list", isinstance(safe_json(r), list))
...
def main():
    start = time.time()
    print("=" * 60)
    print(f"DB Analyzer v5 - System Test (target: {BASE})")
    print("=" * 60)
