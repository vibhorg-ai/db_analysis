...
_V7_ROOT = Path(__file__).resolve().parent.parent.parent
...
class DBRegistry:
    ...
    def _reload(self) -> None:
        ...
        # Pre-configured file
        config_path = _V7_ROOT / settings.db_connections_file
        ...
        custom_path = _V7_ROOT / settings.data_dir / "custom_connections.yaml"
    ...
    def add_connection(
        ...
        *,
        ...
        try:
            ...
            logger.debug("Failed to write custom_connections.yaml: %s", e)
            try:
                os.unlink(tmp_path)
            except OSError:
                pass
    ...
    def remove_connection(self, id: str) -> bool:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.debug("Failed to update custom_connections.yaml (remove): %s", e)
                try:
                    os.unlink(tmp_path)
                except OSError:
                    pass
