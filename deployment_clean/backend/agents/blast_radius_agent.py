"""
Blast Radius Agent — predicts impact of executing queries or schema changes.
"""
...
class BlastRadiusAgent:
    """Predicts impact of executing queries. Classifies as improvement/neutral/degradation."""
