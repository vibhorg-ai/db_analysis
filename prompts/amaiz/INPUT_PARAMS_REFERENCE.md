# Input params function reference (v5)

## Do I need an Input params function?

**No.** In v5, Input params functions are **not needed** for either flow step.
...
In v5, the Python backend does all of this before calling AMAIZ:
...
def prepare_prompt(session_provider, prompt_data=None):
    """
    Minimal input params function for v5.
