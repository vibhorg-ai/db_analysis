"""
Pydantic request/response models for DB Analyzer AI v7 API.
"""
...
class AnalyzeQueryRequest(BaseModel):
    ...
    connection_id: str | None = None
    mode: str = "full"  # "full", "fast", "query_only", "index_only"
...
class PaginatedResponse(BaseModel, Generic[T]):
    """Standard paged list response: items, total count, limit, offset."""
