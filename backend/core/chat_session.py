"""
Chat session context manager for DB Analyzer AI v5.
...
class ChatSession:
    ...
    def build_system_prompt(self, max_tokens: int = 20000) -> str:
        ...
        sections: list[str] = []
        sections.append(
            "You are DB Analyzer AI, an expert database intelligence assistant. "
            "You analyze PostgreSQL and Couchbase databases, reports, schemas, "
            "performance metrics, and provide actionable recommendations. "
