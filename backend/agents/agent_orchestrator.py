...
FAST_STAGES = ["query_analysis", "optimizer"]
...
class AgentOrchestrator:
    ...
    async def run_fast(self, context: dict) -> dict:
        """Run FAST_STAGES (query_analysis + optimizer only)."""
        return await self.run(context, FAST_STAGES)
